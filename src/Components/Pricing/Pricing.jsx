      ...
      <div className="pricing">
        ...
        <div className="pricing__details">
          <p className="pricing__detail pricing__detail-1">
            ...
            functionality will be available to every user, no matter the amount
            of their subscription. If you choose $0, we don’t take any payment
            information, because it’s unnecessary. If you want to help support
            our platform and pay a bit monthly, we are very thankful for your
            support!
          ...
          <p className="pricing__detail pricing__detail-2">
            ...
            The amount of $100 will be charged each month the listing is active
            so long as the business is active in the stages of the hiring
            process by viewing applications, responding to messages, and
            progressing with interviews.
            <span>
              If, however, a business has gotten more than 25 applications and
              is not reviewing, responding, or moving on to next steps, the job
          ...
          <p className="pricing__detail pricing__detail-3">
            our focus is to making the job search approachable for people,
            despite their financial situations while simplifying the process for
